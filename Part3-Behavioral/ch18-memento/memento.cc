...
// Simple example to restore data from Memento
class BankAccount {
    int balance = 0;
public:
    ...
    // to make this class could get the private filed in Memento,
    // we need to declare this class as a friend class in Memento class.
